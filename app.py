...
def handle_message(event):
    ...
    adminID=["U5bd55d60b2112ffb591908d043b7267b","Ua949af5635ed28ba3abbd377b0f276b1","Ue01de340eb97da851243467b6ba179f2",
             "U600f407b05672dd82a6fb54ec5f18270","Ue485a9bf0f3761e976869456dc0424c9"]
    ytKeyword=""
    pushAns=""
    ...
    if keywordCut[0]=="!sr" or keywordCut[0]=="!SR" and len(keywordCut)>=2:
        ...
        line_bot_api.reply_message(event.reply_token, message)
        line_bot_api.push_message("C4fe2e6fd176c7822ed60a78d3941aaea", TextSendMessage(text=event.source.user_id+" "+message))
